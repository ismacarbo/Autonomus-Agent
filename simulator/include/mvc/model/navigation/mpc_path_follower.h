...
struct MpcFollowerConfig {
    ...
    double w_yaw_rate = 0.35;
    double w_yaw_accel = 0.04;
...
class ModelPredictivePathFollower {
public:
    explicit ModelPredictivePathFollower(MpcFollowerConfig config = {});
    ...
    MpcCommand solve(const VehicleGeometry& geometry,
                     ...
                     int anchor_hint_index = 0,
                     VehicleModelKind vehicle_model = VehicleModelKind::CarLikeBicycle) const;
