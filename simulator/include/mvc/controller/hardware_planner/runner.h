...
struct MotorPwmMapperConfig {
    ...
    double left_command_scale = 1.00;
    double right_command_scale = 1.00;
    double left_command_offset = 0.0;
    double right_command_offset = 0.0;
...
struct HardwareTelemetrySample {
    ...
    double external_pose_valid = 0.0;
    double external_pose_source_timestamp_s = 0.0;
    double external_pose_x = 0.0;
    double external_pose_y = 0.0;
    double external_pose_yaw = 0.0;
    double external_pose_quality = 0.0;
...
class HardwarePlannerRunner {
  public:
    ...
    const ExternalPoseReference& external_pose_reference() const {
        return external_pose_reference_;
    }
    bool external_pose_reference_fresh() const;
  ...
  private:
    ...
    void count_unstructured_gate_crossing_if_needed();
