...
EncoderAoState enc_rf = {ENC_RF_AO, 0, 1023, 0, 0, 0, false, false, false, 0UL, 0UL, ENCODER_MIN_SPAN_DEFAULT};
EncoderAoState enc_rr = {ENC_RR_AO, 0, 1023, 0, 0, 0, false, false, false, 0UL, 0UL, ENCODER_MIN_SPAN_DEFAULT};
EncoderAoState enc_lf = {ENC_LF_AO, 0, 1023, 0, 0, 0, false, false, false, 0UL, 0UL, ENCODER_MIN_SPAN_DEFAULT};
EncoderAoState enc_lr = {ENC_LR_AO, 0, 1023, 0, 0, 0, false, false, false, 0UL, 0UL, ENCODER_MIN_SPAN_LR};
...
bool encoders_ready() {
  return enc_rf.valid && enc_rr.valid && enc_lf.valid && enc_lr.valid &&
         enc_rf.armed && enc_rr.armed && enc_lf.armed && enc_lr.armed;
}
